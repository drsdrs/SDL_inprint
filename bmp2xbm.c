...
uint16_t width, height, offset, bpp, byte_width;
...
#define BMP_HEADER_SIZE 54
    ...
    width = ( ( header [ 18 + 0 ] << 0 ) & 0xFF ) | ( ( header [ 18 + 1 ] << 8 ) & 0xFF );

    height = ( ( header [ 22 + 0 ] << 0 ) & 0xFF ) | ( ( header [ 22 + 1 ] << 8 ) & 0xFF );

    offset = ( ( header [ 10 + 0 ] << 0 ) & 0xFF ) | ( ( header [ 10 + 1 ] << 8 ) & 0xFF );

    bpp = ( ( header [ 28 + 0 ] << 0 ) & 0xFF ) | ( ( header [ 28 + 1 ] << 8 ) & 0xFF );
